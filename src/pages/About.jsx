    ...
    <>
      ...
      <section className="max-container">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            As a Full Stack MERN developer, my expertise lies in building
            engaging web applications with the help of React, Next.Js, and
            Tailwind CSS on the frontend side and Express, Node.js on the
            backend side. MongoDB and version control using Git makes me capable
            to deliver projects in an efficient and successful manner
          </p>
        </div>
